...
func (a *AirDrop) Deserialize(buffer *bytes.Buffer) error {
	var err error
	...
	a.Rotation = airdropToQuaternion(rotationVec)
	var airdropType byte
	if err = helpers.ReadByte(buffer, &airdropType); err != nil {
		return err
	} else {
		a.AirDropType = airdropType
	}
	if err = helpers.ReadByte(buffer, &a.AirDropType); err != nil {
		return err
	}
	if err = helpers.ReadByte(buffer, &a.ObjectId); err != nil {
		return err
	}
	if err = helpers.ReadString(buffer, &a.IdString); err != nil {
		return err
	}
	if err = helpers.ReadBool(buffer, &a.IsStatic); err != nil {
		return err
	}
	if err = helpers.ReadBytesAndSize(buffer, &a.ItemPart1); err != nil {
		return err
	}
	if err = helpers.ReadBytesAndSize(buffer, &a.ItemPart2); err != nil {
		return err
	}
	return nil
}

func (a *AirDrop) Serialize(buffer *bytes.Buffer) error {
	var err error
	...
	if err = airdropToVector3(&a.Rotation).Serialize(buffer); err != nil {
		return err
	}
	if err = helpers.WriteByte(buffer, byte(a.UniqueId)); err != nil {
		return err
	}
	if err = helpers.WriteByte(buffer, a.AirDropType); err != nil {
		return err
	}
	if err = helpers.WriteByte(buffer, a.ObjectId); err != nil {
		return err
	}
	if err = helpers.WriteString(buffer, a.IdString); err != nil {
		return err
	}
	if err = helpers.WriteBool(buffer, a.IsStatic); err != nil {
		return err
	}
	if err = helpers.WriteBytesAndSize(buffer, a.ItemPart1); err != nil {
		return err
	}
	if err = helpers.WriteBytesAndSize(buffer, a.ItemPart2); err != nil {
		return err
	}
	return nil
}
