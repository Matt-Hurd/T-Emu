...
wt -w 0 nt -p "Command Prompt" cmd /k "npx local-ssl-proxy --source 8091 --target 8090 && pause"
wt -w 0 nt -p "Command Prompt" cmd /k "npx local-ssl-proxy --source 9091 --target 9090 && pause"